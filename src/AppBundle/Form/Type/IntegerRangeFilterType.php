 ...
 */
class IntegerRangeFilterType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $builder->add('left_number', IntegerFilterType::class, $options['left_number_options']);
        $builder->add('right_number', IntegerFilterType::class, $options['right_number_options']);
